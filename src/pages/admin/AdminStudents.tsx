    ...
    { id: 'joined', label: 'Joined', minWidth: 110, render: (s) => <span className="text-slate-400 text-xs">{s.createdAt ? new Date(s.createdAt).toLocaleDateString('en-GB', { day: '2-digit', month: 'short', year: 'numeric' }) : '-'}</span> },
    {
      ...
      render: (s) => (
        <div className="flex items-center justify-end gap-1">
          <button onClick={() => setViewStudent(s)} title="View" className="p-1.5 rounded-lg bg-slate-50 text-slate-500 hover:bg-slate-100 hover:text-slate-700 transition">
          ...
          <button onClick={() => openEdit(s)} title="Edit" className="p-1.5 rounded-lg bg-blue-50 text-blue-500 hover:bg-blue-100 hover:text-blue-700 transition">
          ...
          <button onClick={() => handleDelete(s.id)} title="Delete" className="p-1.5 rounded-lg bg-red-50 text-red-500 hover:bg-red-100 hover:text-red-700 transition">
